...
![Untitled](./assets/img/Flamingo/Untitled%201.png)

위 그림같이 image-text pair들의 sequence로 training하고 few-shot으로 돌릴 수 있음

![Untitled](./assets/img/Flamingo/Untitled%202.png)
...
- Perceiver Resampler
    ...
    ![Untitled](./assets/img/Flamingo/Untitled%203.png)
...
- GATED XATTN-DENSE layers
    ...
    ![Untitled](./assets/img/Flamingo/Untitled%204.png)
...
- Multi-visual input support: per-image/video attention masking
    ...
    ![Untitled](./assets/img/Flamingo/Untitled%205.png)
...
- objective
    ...
    ![Untitled](./assets/img/Flamingo/Untitled%206.png)
...
- Few-Shot Results
    - outperforms by a large margin, SOTA!
        ...
        ![Untitled](./assets/img/Flamingo/Untitled%207.png)

    - model 사이즈가 클수록 few-shot performance가 좋음. 물론 shot 개수 많을수록 performance가 좋음

        ![Untitled](./assets/img/Flamingo/Untitled%208.png)

- Fine-tuning Flamingo

    ![Untitled](./assets/img/Flamingo/Untitled%209.png)
...
- Ablation studies
    ...
    ![Untitled](./assets/img/Flamingo/Untitled%2010.png)
